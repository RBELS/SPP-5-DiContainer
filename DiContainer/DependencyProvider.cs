...
public class DependencyProvider
{
    ...
    public DependencyProvider(DependenciesConfiguration configuration)
    {
        if (!IsValidConfig(configuration))
            throw new DependencyProviderException("Not valid configuration");
    ...
    private object Resolve(Type dependency, Enum? id = null)
    {
        try
        {
        ...
        {
            throw new DependencyProviderException("Couldn't get implementation", ex);
        }
    }
    ...
    private object GetImplementationList(Type dependency)
    {
        ...
        if (list is null)
            throw new DependencyProviderException("Couldn't create implementations list");
        ...
        {
            if (obj is null)
                throw new DependencyProviderException("Couldn't create object");
