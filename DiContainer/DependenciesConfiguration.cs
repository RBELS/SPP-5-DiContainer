...
{
    private readonly ConcurrentDictionary<Type, ConcurrentBag<ImplementationDescription>> _lookupTable = new();

    public void Register(Type dependency, Type implementation, Enum? id = null, Lifecycle lifecycle = Lifecycle.Transient)
    {
